        ...
        <section className="border-hard bg-white flex flex-col md:flex-row">
          ...
          <div className="p-6 md:p-12 md:w-1/3 text-white flex flex-col justify-center" style={{ backgroundColor: "#2a2e30" }}>
            ...
            <div className="space-y-4 text-sm font-bold leading-tight">
              ...
              <p className="uppercase text-base" style={{ color: "#ff9e7a" }}>So nothing compounds. Nothing sticks.</p>
          ...
          <div className="md:col-span-1 border-hard bg-white flex flex-col">
            ...
            <div className="p-6">
              ...
              <div className="text-xs font-bold space-y-3">
                ...
                <p>In 2021 I cut the golden handcuffs to go all in on my coaching business. By 2024 we'd generated over $1M in revenue and had a client list of over 100 high-ticket clients. Then the market shifted. So I made a pivot.  I re-imagined my business to a stress-free modal, while still delivering mad value.</p>
